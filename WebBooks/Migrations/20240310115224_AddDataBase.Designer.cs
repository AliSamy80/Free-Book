...
namespace WebBooks.Migrations
{
    ...
    [Migration("20240310115224_AddDataBase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domin.Entity.SubCategorry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("SubCategorries");
                });

            modelBuilder.Entity("Domin.ViewModel.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Domin.Entity.Book", b =>
                {
                    ...
                    b.HasOne("Domin.Entity.SubCategorry", "SubCategorry")
                        .WithMany()
            ...
            modelBuilder.Entity("Domin.Entity.LogSubCategory", b =>
                {
                    b.HasOne("Domin.Entity.SubCategorry", "SubCategory")
                        .WithMany()
                        .HasForeignKey("SubCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Domin.ViewModel.ApplicationUser", null)
                        .WithMany()
